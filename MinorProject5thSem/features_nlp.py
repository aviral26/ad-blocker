...
with open('/Users/ayushchd/Documents/ml/ml-003/ex1_003/ex1/data_input_wsj_nlp.csv', 'wb') as f:  # Just use 'w' mode in 3.x
	    w = csv.DictWriter(f, features[0].keys())
	    w.writeheader()
	    w.writerows(features)

with open('/Users/ayushchd/Documents/ml/ml-003/ex1_003/ex1/data_output_wsj_nlp.csv', 'wb') as f:  # Just use 'w' mode in 3.x
